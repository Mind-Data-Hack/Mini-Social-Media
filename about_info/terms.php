...
<meta name="keywords" content="blogs,Terms, Terms of Use,Freeby,Freeby.in,blog,news,updates,corona,covid,updates,register,login,upload,id,reviews,users,friends,people,live">
...
<div class="w3-content w3-container w3-padding-64" id="about">
 <center><p class="w3-center"><h3>What We Describe?</h3></p></center>
  <p>Here We Describe How You can use this Product And What Type Of Content You can Upload To This Site. Hope So It's Helpful.</p>
  <div class="w3-row">
    <div class="w3-col m6 w3-center w3-padding-large">
      <p style="color: black;"><b>Content And Reviews Uploading</b></p><br>
      <img src="../icons/freeby.png">
    </div>

    <!-- Hide this text on small devices -->
    <div class="w3-col m6 w3-hide-small w3-padding-large">
      <p>You can Upload Any Type Of Content And Reviews But Make Sure Your Content Is Not Sexual And Don't Damage Anyone's Image.Your Content Must Not Be Insulted Any Religion.Instead of This You can Upload Any Content.</p>
