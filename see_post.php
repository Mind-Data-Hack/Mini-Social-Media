...
if(isset($_GET['see_post'])){
  ...
  $get_id = $_GET['see_post'];

  $get_posts = "select * from blogs where blog_id='$get_id'";
...
<meta name="keywords" content="blogs,<?php echo $title; ?>,<?php echo $content; ?>,freeb,freeby,freeby.in,freeby.com,freebies,freeb.com,freeby.com,blog,news,updates,corona,covid,updates,register,login,upload,id,reviews,users,friends,people,live">
